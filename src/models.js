...
class Listener {
   ...
   */
  emitAdded(index: number | string | null, value: IValue) {
   ...
   */
  emitRemoved(index: number | string | null, value: IValue) {
