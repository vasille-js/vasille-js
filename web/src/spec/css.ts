...
export type RawStyleProps = StandardPropertiesHyphen<string | number | number[]> &
    ...
    ObsoletePropertiesHyphen<string | number | number[]> & { [variable: `--${string}`]: string };
export type StyleSheetProps = { [K in keyof RawStyleProps]: RawStyleProps[K] | RawStyleProps[K][] };
